    ...
    <body>
       ...
       <section class="section-features js--section-features" id="features">
           ...
           <div class="row  js--wp-1">
               <div class="col span-1-of-4 box">        <i class="icon ion-md-infinite icon-big"></i>
                  <h3>Up to 365 days/year</h3>
                   <p>Never cook again! We really mean that. Our subscription plans include up to 365 days/year coverage. You can also choose to order more flexibly if that's your style.</p>
               </div>
               <div class="col span-1-of-4 box">        <i class="icon ion-md-alarm icon-big"></i> 
                  <h3>Ready in 20 minutes</h3>
                   <p>You're only twenty minutes away from your delicious and super healthy meals delivered right to your home. We work with the best chefs in each town to ensure that you're 100% happy.</p>
               </div>
               <div class="col span-1-of-4 box">        <i class="icon ion-md-nutrition icon-big"></i> 
                  <h3>100% organic</h3>
                   <p>All our vegetables are fresh, organic and local. Animals are raised without added hormones or antibiotics. Good for your health, the environment, and it also tastes better!</p>
               </div>
               <div class="col span-1-of-4 box">        <i class="icon ion-md-cart icon-big"></i> 
       ...
       <section class="section-steps" id="steps">
           ...
           <div class="row">
               ...
               <div class="col span-1-of-2 steps-box">
                   ...
                   <a href="" class="button-app"><img src="resources/images/download-app-android.png" alt="Play Store"></a>
                   <a href="" class="button-app"><img src="resources/images/download-app.svg" alt="App Store Button"></a>
               </div>
           </div>
       </section>
           ...
           <div class="row">
               <div class="col span-1-of-3">
                   <div class="plan-box js--wp-4">
                       ...
                       <div>
                           <ul>
                               <li><i class="icon ion-md-checkbox-outline icon-small"></i>1 meal every day</li>
                               <li><i class="icon ion-md-checkbox-outline icon-small"></i>Order 24/7</li>
                               <li><i class="icon ion-md-checkbox-outline icon-small"></i>Access to newest creations</li>
                               <li><i class="icon ion-md-checkbox-outline icon-small"></i>Free delivery</li>
                           </ul>
                       </div>
                       <div>
                ...
                <div class="col span-1-of-3">
                   <div class="plan-box">
                       ...
                       <div>
                           <ul>
                               <li><i class="icon ion-md-checkbox-outline icon-small"></i>1 meal 10 days / month</li>
                               <li><i class="icon ion-md-checkbox-outline icon-small"></i>Order 24/7</li>
                               <li><i class="icon ion-md-checkbox-outline icon-small"></i>Access to newest creations</li>
                               <li><i class="icon ion-md-checkbox-outline icon-small"></i>Free delivery</li>
                           </ul>
                ...
                <div class="col span-1-of-3">
                   <div class="plan-box">
                       ...
                       <div>
                           <ul>
                               <li><i class="icon ion-md-checkbox-outline icon-small"></i>1 meal</li>
                               <li><i class="icon ion-md-checkbox-outline icon-small"></i>Order from 8 am to 12 pm</li>
                               <li><i class="icon ion-md-close-circle-outline icon-small"></i></li>
                               <li><i class="icon ion-md-checkbox-outline icon-small"></i>Free delivery</li>
                           </ul>
                       </div>
                       <div>
       ...
       <footer>
           <div class="row">
               <div class="col span-1-of-2">
                   <ul class="footer-nav">
                       ...
                       <li><a href="">Blog</a></li>
                       <li><a href="">Press</a></li><li><a href="">iOS App</a></li>
           ...
           <div class="row">
               <p> Copyright &copy; 2015 by Omnifoot. All rights reserved.</p>
           </div>
       </footer>
